    ...
    <div>
        ...
        >
            ...
            <div v-else>
                ...
                Но птицы у разных продавцов отличаются сертификатом. Чтобы его получить, птицу должен осмотреть врач.
                Тогда он выдает сертификат о том, что птица здорова, и можно продавать ее яйца. Сертификат можно
                    купить отдельно, а можно экономить и покупать сразу птиц с сертификатами.</span>
                <b-button
