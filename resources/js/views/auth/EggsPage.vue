        ...
        <div class="position-relative">
            ...
            <b-collapse :visible="localStorage.getItem('tooltip-eggs') == 'true'" id="collapse-shovel">
                <p>
                    ...
                    Каждый час вам приходит налог на птиц. Чем лучше сертификат птицы, тем меньше штраф.
                </p>
            </b-collapse>
            ...
            <h2 class="d-flex justify-content-between">
                ...
                <b-button
                    ...
                    v-b-tooltip="'Если сумма штрафов и налогов будет больше 300, то у вас не будет доступа к яйцам!'"
                >
                    Погасить налоги
                    {{ +getFines }} ₽
                </b-button>
