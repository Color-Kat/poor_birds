        ...
        getShovel(state) {
            ...
            if (shovel) {
                return {
                    ...
                    efficiency: ['Эффективность', `${shovel.efficiency.toLocaleString()} ед.помёта`],
                    price     : ['Цена лопаты', `${shovel.price ? shovel.price.toLocaleString() + '₽' : shovel.donate_price.toLocaleString() + ' густинианов'} `],
